...
class Vaadin::ElementsTest < Minitest::Test
  ...
  def test_import
    ...
    assert_equal "<script src=\"http://polygit2.appspot.com/polymer+:master/vaadin-grid+vaadin+*/vaadin-combo-box+vaadin+*/vaadin-date-picker+vaadin+*/vaadin-icons+vaadin+*/components/webcomponentsjs/webcomponents-lite.min.js\"></script>\n<script src=\"http://momentjs.com/downloads/moment.min.js\"></script>\n<script src=\"https://raw.githubusercontent.com/vaadin-miki/vaadin-elements-jsrubyconnector/master/connector.js\"></script>\n<link href=\"http://polygit2.appspot.com/polymer+:master/vaadin-grid+vaadin+*/vaadin-combo-box+vaadin+*/vaadin-date-picker+vaadin+*/vaadin-icons+vaadin+*/components/vaadin-grid/vaadin-grid.html\" rel=\"import\">\n<link href=\"http://polygit2.appspot.com/polymer+:master/vaadin-grid+vaadin+*/vaadin-combo-box+vaadin+*/vaadin-date-picker+vaadin+*/vaadin-icons+vaadin+*/components/vaadin-combo-box/vaadin-combo-box.html\" rel=\"import\">\n<link href=\"http://polygit2.appspot.com/polymer+:master/vaadin-grid+vaadin+*/vaadin-combo-box+vaadin+*/vaadin-date-picker+vaadin+*/vaadin-icons+vaadin+*/components/vaadin-date-picker/vaadin-date-picker.html\" rel=\"import\">\n<link href=\"http://polygit2.appspot.com/polymer+:master/vaadin-grid+vaadin+*/vaadin-combo-box+vaadin+*/vaadin-date-picker+vaadin+*/vaadin-icons+vaadin+*/components/vaadin-icons/vaadin-icons.html\" rel=\"import\">", js
  end
