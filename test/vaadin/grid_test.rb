...
class Vaadin::GridTest < Minitest::Test
  ...
  def test_named_immediate
    ...
    assert_equal "<vaadin-grid id=\"country\" name=\"country\"></vaadin-grid><script async=\"false\" defer=\"true\">document.addEventListener(\"WebComponentsReady\", function(e) {var cb = document.querySelector(\"#country\");cb.items = [{\"code\":\"PL\",\"english\":\"Poland\",\"name\":\"Polska\"},{\"code\":\"FI\",\"english\":\"Finland\",\"name\":\"Suomi\"},{\"code\":\"DE\",\"english\":\"Germany\",\"name\":\"Deutschland\"},{\"code\":\"SE\",\"english\":\"Sweden\",\"name\":\"Sverige\"}];cb.selection.select(0);cb.addEventListener('selected-items-changed', function(e) {selection = document.querySelector(\"#country\").selection.selected(function(index){var grItem;document.querySelector(\"#country\").getItem(index, function(err, item){grItem=index;});return grItem;});ajax.post('/country', {'country': JSON.stringify(selection)}, null);});});</script>", html
  end

  def test_named_immediate_verbose
    html = vaadin_grid(:country, @countries, immediate: true, verbose_event: true)
    assert_equal "<vaadin-grid id=\"country\" name=\"country\"></vaadin-grid><script async=\"false\" defer=\"true\">document.addEventListener(\"WebComponentsReady\", function(e) {var cb = document.querySelector(\"#country\");cb.items = [{\"code\":\"PL\",\"english\":\"Poland\",\"name\":\"Polska\"},{\"code\":\"FI\",\"english\":\"Finland\",\"name\":\"Suomi\"},{\"code\":\"DE\",\"english\":\"Germany\",\"name\":\"Deutschland\"},{\"code\":\"SE\",\"english\":\"Sweden\",\"name\":\"Sverige\"}];cb.selection.select(0);cb.addEventListener('selected-items-changed', function(e) {selection = document.querySelector(\"#country\").selection.selected(function(index){var grItem;document.querySelector(\"#country\").getItem(index, function(err, item){grItem=index;});return grItem;});ajax.post('/country', {id: 'country', value: JSON.stringify(selection), name: 'country', 'country': JSON.stringify(selection)}, null);});});</script>", html
  end
  ...
  def test_implicit_named_immediate_verbose
    html = vaadin_grid @countries, id: 'grid', immediate: true, name: 'country', verbose_event: true
